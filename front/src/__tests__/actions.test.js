...
describe('actions', () => {
    it('should create an action to set jobs', () => {
        const expectedAction = {
            type: "setJobs",
            value: JOBS
        }
        expect(actions.setJobs(JOBS)).toEqual(expectedAction)
    })

    it('should create an action to set mercs', () => {
        const expectedAction = {
            type: "setMercs",
            value: MERCS
        }
        expect(actions.setMercs(MERCS)).toEqual(expectedAction)
    })
})
